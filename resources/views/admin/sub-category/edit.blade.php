                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('sub-category.update', ['id' => $sub_category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <label><input type="radio" {{$sub_category->status == 1 ? 'checked' : ''}}  name="status" value="1"> Published</label>
                                <label><input type="radio" {{$sub_category->status == 0 ? 'checked' : ''}} name="status" value="0"> Unpublished</label>
                            </div>
                        </div>
